...
- Auth kommt aus Codex-Umgebung (GitHub-App/gh auth/Credential Helper) — keine Credentials/Tokens in Ausgaben
...
### TIER-Kategorien in checkup_builder_config.js (5 Werte)

| Tier | Bedeutung |
|------|-----------|
| `STANDARD` | Standardwert im Panel/Thema |
| `OPTIONAL` | Optionaler Zusatzwert |
| `SPEZIAL` | Spezialwert |
| `NUR_FACHPERSON` | Nur nach fachlicher Einordnung |
| `NICHT_TEIL_DES_GROSSEN_BLUTBILDS` | Außerhalb großes Blutbild, in thematischen Listen erlaubt — kein Diagnose-Framing |
