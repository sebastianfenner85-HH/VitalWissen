...
| **`zusatzstoffe`** | **35** | ✅ | S18-Build-05 (23.04.2026) — 7 Kategorien, 3 Indizes, anon read; ~12 Einträge mit hinweise_vorsicht (nur regulatorisch belegt) |
| **`studien`** | **20** | ✅ | Schema: S3-SCHEMA-MIGRATION-APPLY (13.05.2026) — 46 Felder, 3 ENUMs, 16 Indexes, Trigger, RLS Policy `anon_read_approved_public`, Gate-K.4-Constraint. **Content: S3-APPROVAL-REVIEW-01 (14.05.2026)** — 20 Rows (5 ICD-Cluster × 4: I10/E11/F32/E03/D50), `curation_status='approved'`, `visibility='public'`, `retraction_status='nicht_retracted'`. 2 Repairs: Slug-Korrektur Peña-Rosas-2015 + Camaschella studientyp→`narrativer_review`/level→4. anon sieht 20 Rows ✅ (RLS PASS). **14/14 Validatoren PASS.** |
...
**Status:** ✅ **S9-HEALTH-AVATAR-CONTEXT-FREEZE abgeschlossen (13.05.2026)** — Read-only Strategie-Freeze. 20 Sektionen, alle 19 ZK-Fragen beantwortet. Profiltypen P1–P6, Einwilligungsmodell LB-0–LB-3, Datenhaltungsmodell (lokal/server, E2E AES-256), Update-Typen U1–U5, KI-Schnittstellen-Grenze (Klasse 3–5 nur mit opt-in, Klasse 4 strukturell blockiert), S4/Q4/Q5/Q7/Q9/DSGVO-Art.9-Schnittstellen eingefroren. 4 Blocker dokumentiert (B1 AVV Supabase, B2 S9-DSE Rechtsanwalt, B3 Key-Management-Spec, B4 FHIR-Bibliothek). 12 No-Gos bindend. KI-Prompt-Export (Modus 3a) als Phase-C-Feature ohne S9 spezifiziert.
Kein Code. Kein DB-Write. Kein Commit. Kein Deploy.
Nächster Schritt: S3-Curation-Queue (operativ, eigenständiger Chat) → Phase-C (Q5/Q4/KI-Prompt-Export) → Phase-D-Vorbereitung (B1–B4 schließen) → S9-Build.
Führend: `01_PROJECT_SOURCES_CURRENT/S9_HEALTH_AVATAR_CONTEXT_FREEZE.md`

### S3 — Studienkompass
**Status:** ✅ **S3-BUILD-01 live (14.05.2026, Commit `97f07e8`)** — Block [15] auf 5 Pilot-Krankheitsseiten (I10/E11/F32/E03/D50). 20/20 Studien approved/public. Studienkarten: Typ-Chip, Evidence-Badge Lvl 1-5, Hype-Flags, Show-All-Toggle, Disclaimer. Detailseite `/studien/:slug` (StudienDetail.jsx) als Pflicht-Link. CSS `s3-*` in Krankheiten.css (56 Klassen, mobile-first, Tap-Targets ≥ 44px). Empty-State: Block vollständig absent bei 216 Nicht-Pilot-Krankheiten. queries.js: getStudienByKrankheit() + getStudieBySlug(). 5 Dateien, kein DB-Write. V1-V14 PASS.
Nächster Schritt: S3-BUILD-02 (Studien-Hub `/studien`, optional, eigenständiger Chat nach expliziter Freigabe).
Führend: `01_PROJECT_SOURCES_CURRENT/S3_BUILD_01_CLOSURE.md` · `01_PROJECT_SOURCES_CURRENT/S3_APPROVAL_REVIEW_01_CLOSURE.md` · `01_PROJECT_SOURCES_CURRENT/S3_UX_SPEC.md`
...
*Aktualisiert: 07.05.2026 — S3-MVP-SLICE-SPEC ✅ MVP-Slice-Spezifikation Studienkompass abgeschlossen. Option C (Krankheiten-only/K1) gewählt: 5 ICD-Cluster (I10/E11/F32/E03/D50), 20 K6-Einträge (4 je Cluster), Modus 1 (Cross-Block [15] auf S5-Seiten). ICD = interne Objektanker; PubMed/OpenAlex = kuratierte MeSH-nahe Suchterme. Originalabstract C.1 NEIN / C.2 nur mit Lizenz/OA-Clearance. CSS-Prefix `s3-*`. Keine Build-Freigabe. Kein Code, kein DB-Write, kein Commit. §7 S3-Strang + Führend-Verweis nachgezogen.*
*Aktualisiert: 07.05.2026 — S3-MVP-SLICE-SPEC Customer-Value-Patch ✅. H0 (Kundennutzen/Findability/Erwartungsmanagement) ergänzt: Produktversprechen C.1, Coverage-Regel (K4/K5/K3/K7 nicht in C.1), Findability-Tabelle, Empty-State-Regel, Nutzerwert, Ausbaureihenfolge, UX-Claim. MVP-Entscheidung unverändert. §7 S3-Strang um Customer-Value-Patch erweitert. Kein Code, kein DB-Write, kein Commit.*
